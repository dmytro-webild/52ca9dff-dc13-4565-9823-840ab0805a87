...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        {
          imageSrc: "http://img.b2bpic.net/free-photo/delicious-street-food-still-life_23-2151535327.jpg",
          imageAlt: "Authentic Tacos",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/sliced-apples-peaches-peers-served-large-mirror_1304-4688.jpg",
          imageAlt: "Carne Asada",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-appetizing-pozole-bowl_23-2149248558.jpg",
          imageAlt: "Pozole Rojo",
        },
        {
  ...
  <div id="about" data-section="about">
      ...
      heading={[
        ...
        {
          type: "image",
          src: "http://img.b2bpic.net/free-photo/beautiful-mexican-party-decoration-with-food_23-2149317309.jpg",
          alt: "Mexican Dining Atmosphere",
        },
      ]}
    />
  </div>
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          name: "Carne Asada",
          price: "$18.00",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-pears-with-green-apples-grapes-kiwi-basket-yellow-checkered-towel-with-colored-pancakes-stand-white-background_141793-53511.jpg",
        },
        {
          id: "p3",
          name: "Pozole Rojo",
        ...
        },
        {
          ...
          name: "Fried Fish",
          price: "$14.00",
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-fish-chips-plate-with-lemon-slice_23-2148784867.jpg",
        },
        {
          id: "p5",
          name: "Quesadillas",
      ...
      accordionItems={[
        {
          ...
          content: "Everything is prepared fresh to ensure the highest quality for your family meal.",
        },
        {
          id: "a2",
          title: "Traditional Recipes",
          content: "Our recipes passed down through generations deliver an unmatched authentic taste.",
        },
        {
          id: "a3",
          title: "Friendly Staff",
          content: "We pride ourselves on providing excellent service that makes everyone feel welcome.",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Faith",
          handle: "@foodie",
          testimonial: "I love the tacos because they have a wide selection and yes the lengua tacos were delicious!",
          rating: 5,
        ...
        },
        {
          ...
          name: "Josue",
          handle: "@guide",
          testimonial: "If you want food for the money you pay then this is the place to go plus the dishes are delicious.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Jessica",
          handle: "@fan",
          testimonial: "Food was excellent, as always! I will definitely continue to recommend this place.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Michael",
          handle: "@local",
          testimonial: "Absolutely great authentic experience. Highly recommended for any Mexican food lover.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Sarah",
          handle: "@user",
          testimonial: "Really clean place, service is great and food is really authentic.",
          rating: 5,
      ...
      faqs={[
        {
          ...
          content: "Yes, we offer both takeout and delivery services for your convenience.",
        },
        {
          id: "q2",
          title: "Are you open on weekends?",
          content: "We are open daily to serve you our authentic Mexican dishes.",
        },
        {
          id: "q3",
          title: "Is there seating available?",
          content: "Yes, we have comfortable dine-in seating for all our guests.",
        },
      ]}
